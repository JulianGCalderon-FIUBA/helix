//! Moves messages between the editor and the session's gossip topics.
//!
//! This knows about topics and messages, but not about buffers: what to do
//! with a message is up to [`super::collab`].
...
use super::proto::{self, Announcement, FileMessage, SessionMessage, SessionTicket};
